...
describe("Home page", () => {
  ...
  it("Mudando cores para o dark theme", () => {
    cy.get("#fa-sun").should("have.length", 1).click();

    cy.get("#fa-moon").should("have.length", 1).click();
  });
